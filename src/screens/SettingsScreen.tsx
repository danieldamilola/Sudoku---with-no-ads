    ...
    {[
      ...
      return (
        <TouchableOpacity
          ...
          style={[
            S.segmentBtn,
            active && { backgroundColor: colors.bgSurfaceContainerLowest },
          ]}
    ...
    >
      ...
      >
        ...
        >
          <View style={S.row}>
            <View style={S.rowTxt}>
              <Text style={[S.rowLbl, { color: colors.textPrimary }]}>
                Color Theme
              </Text>
              <Text style={[S.rowSub, { color: colors.textSecondary }]}>
                Match the quiet ink design.
              </Text>
            </View>
            <ThemeSegment
        ...
        >
          <View style={S.row}>
            <View style={S.rowTxt}>
              ...
              <Text style={[S.rowSub, { color: colors.textSecondary }]}>
                Stop the game after too many wrong entries.
              </Text>
            </View>
            <View style={[S.segment, { backgroundColor: colors.bgSurfaceContainer }]}>
              {[
                ...
                const active = settings.mistakeLimit === item.value;
                return (
                  <TouchableOpacity
                    key={item.label}
                    style={[
                    ...
                    onPress={() => set("mistakeLimit", item.value)}
                    activeOpacity={0.75}
                  >
                    <Text
                      style={[
          ...
          <ToggleRow
            ...
            sub="Show same digits on selection"
            value={settings.highlightDuplicates}
            onChange={(v) => set("highlightDuplicates", v)}
            colors={colors}
          />
          <Div colors={colors} />
          <ToggleRow
            label="Show Timer"
            sub="Track your solution speed"
        ...
        >
              ...
              Alert.alert(
                ...
                [
                  { text: "Cancel", style: "cancel" },
                  {
                    text: "Reset",
                    style: "destructive",
                    onPress: () => useStore.getState().resetStats(),
                  },
                ],
              )
            }
          ...
          >
            <View style={S.rowTxt}>
              <Text style={[S.rowLbl, { color: colors.error }]}>
                Reset Game Data
              </Text>
              <Text style={[S.rowSub, { color: colors.textSecondary }]}>
                Clear stats and all progress
              </Text>
            </View>
        ...
        >
          ...
          >
            <View style={S.rowTxt}>
              ...
              <Text style={[S.rowSub, { color: colors.textSecondary }]}>
                {user ? "Sync enabled" : "Playing locally"}
              </Text>
            </View>
            <User size={18} color={colors.textPrimary} strokeWidth={1.8} />
          </TouchableOpacity>
        </View>
...
const S = StyleSheet.create({
  ...
  rowLbl: { fontSize: 16, fontWeight: "600" },
